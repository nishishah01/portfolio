    ...
    <div className="flex flex-wrap gap-5">
      {items.map((skill, index) => (
        <motion.div
          ...
          className="flex items-center gap-4 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg px-8 py-3 rounded-full border border-white/20 shadow-[inset_0_1px_3px_rgba(255,255,255,0.3),0_4px_30px_rgba(0,0,0,0.1)] hover:border-accent-2/50 hover:bg-white/10 hover:shadow-[inset_0_1px_3px_rgba(255,255,255,0.4),0_8px_30px_rgba(233,69,96,0.2)] transition-all duration-300 cursor-default"
        >
        ...
        <div className="max-w-7xl mx-auto mt-20">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {skills.cloudTechnologies.map((comp, i) => (
                <span
                  key={i}
